...
#TODO THIS IS BAD PRACTICE: THE HIDDEN_LAYER_SIZE AND OUTPUT_EMB_SIZE SHOULD BE TUNABLE BY THE USERS; WITH A DEFAULT OPTION. What is the syntax for that again? Patrick? 
