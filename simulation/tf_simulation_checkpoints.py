    ...
    with summary_writer.as_default():
        ...
        for step in range(hyperparams.sim_params.outer_loop):
            ...
            for innerstep in range(hyperparams.sim_params.inner_loop):           
                ...
                energy, loc_energies=stochastic_energy_tf(psi_new, sampler_var, edge_pairs, template_graphs_output, GT_Batch_update, 0.0)
                # stoch_loss, stoch_grads=stochastic_overlap_gradient(phi_terms, GT_Batch_update, sampler_var)
                stoch_loss, stoch_grads=improved_stochastic_gradients(phi_terms, GT_Batch_update, sampler_var.model)
